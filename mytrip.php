...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="Mytrip.css">
			...
			<div id="mytrip">
				<div class="mantrip">
					...
					<?php
						...
						<div class='mantripDetail'><img src='img/grup2.png' class='mantripIcon' alt='image'> <a href='#'>Grup Discussion</a></div>
					</div>";
						}
					?>
